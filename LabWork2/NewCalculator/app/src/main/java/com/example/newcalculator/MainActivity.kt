...
import com.example.newcalculator.text_analyzer.MainCameraActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun SetDetectedText(text:String){
        display.setText(text)
        val cursorPs = display.selectionStart
        display.setSelection(cursorPs + text.length)
    }
    ...
    fun OnScanClick(view: View) {
        ...
        val intent = Intent(context, MainCameraActivity::class.java)
